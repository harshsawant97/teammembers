...
function AppContent() {
  ...
  const isAdminDashboard = location.pathname.includes('/dashboard') || location.pathname.includes('/students') || location.pathname.includes('/history') || location.pathname.includes('/classes') || location.pathname.includes('/settings');
  ...
  return (
    <Box sx={{ display: 'flex' }} className="w-full min-h-screen">
      ...
      <Box component="main" sx={{ flexGrow: 1 }} className="overflow-x-hidden">
        <Routes>
